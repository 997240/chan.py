...
from common.enums import AUTYPE, DATA_FIELD, KL_TYPE
from common.ctime import CTime
from common.func_util import kltype_lt_day, str2float
from kline.kline_unit import KLineUnit

from .common_stock_api import CommonStockApi
...
class BaoStock(CommonStockApi):
    is_connect = None

    def __init__(self, code, k_type=KL_TYPE.K_DAY, begin_date=None, end_date=None, autype=AUTYPE.QFQ):
        super(BaoStock, self).__init__(code, k_type, begin_date, end_date, autype)
    ...
    def get_kl_data(self):
        ...
        while rs.error_code == '0' and rs.next():
            yield KLineUnit(create_item_dict(rs.get_row_data(), get_column_name_from_field_list(fields)))
