from combiner.kline_combiner import KLineCombiner
from common.enums import FX_CHECK_METHOD, FX_TYPE, KLINE_DIR
...
# 合并后的K线
class KLine(KLineCombiner[KLineUnit]):
    def __init__(self, kl_unit: KLineUnit, idx, _dir=KLINE_DIR.UP):
